...
const projects = [
  ...
  },
  {
    id: 5,
    name: "Formalify",
    description: "A website where students can learn and practice their formulas of Maths Physics and Chemistry for classes 9th 10th 11th and 12th.",
    tags: ["Typescript","Next.js","Web App","Full-Stack"],
    icon: "/formalify.png",
    bannerBg: "linear-gradient(135deg, rgba(37,35,35,0.2) 0%, rgba(112,121,140,0.25) 100%)",
    link: "https://formalify.vercel.app/",
    repo: "https://github.com/adarshg-org-13/Formalify",
    ghost: false,
  },
  {
    id: 6,
